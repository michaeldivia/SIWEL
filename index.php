		...
		<body>
			<div class="bodyContainer">
				...
				<div class="input-group" id="inputFormuleSemi">
					...
					<input type="text" placeholder="CH3-CH2-CH3" value="CH3-CH2-CH3" class="form-control" aria-describedby="case pour la formule semi-développée" id="atomsToDecompose" onkeypress="if(window.event.keyCode==13)conversionFormuleSemiDeveloppee()">
				</div>
